...
const Champions = MethodType("getchampions")
...
# /playerID
const PlayerLoadouts = MethodType("getplayerloadouts")
# /player
# 0 - Offline
...
# /player
const ChampionRanks = MethodType("getchampionranks")
# /player/queue
...
# /playername
const PlayerXboxAndSwitch = MethodType("getplayeridinfoforxboxandswitch")
# End
...
# /champion/lang
const ChampionSkins = MethodType("getchampionskins")
const ChampionRecommendedItems = MethodType("getchampionecommendeditems")
# /god/lang
